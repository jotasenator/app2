...
const MyHistoryPython = () => {
    return (
        <div>
            ...
            <br id='content1' /><br /><br /><br /><br /><br /><br />
            ...
            <p>Yo no sabía programar en ningún lenguaje pero estaba seguro que tener esta
            habilidad podría serme útil cuando fuera a enfrentarme a algún problema, a
            ...
            <p>R/ Pueda que hayan otros pero <strong>Python</strong> cambió mi vida.</p>
            ...
            <div className='orderedList'>
                <ol>
                    <li>Lo primero es instalar Python, desde la página oficial de XXlink a página de
                    Python link officialXX.
                </li>
                    ...
                    lo mismo, aunque después encontrarás otros que pueden ser de tu interés. Puedes descargarlo aquí
                    XXXlink de la pagina XX

                </li>
                    <li><a href='./books/python/Python_for_Dummies_(2006).pdf' download>Python_for_Dummies.pdf</a>.
                    ...
                    <li>Curso de youtube “Píldoras informáticas”. El profesor XXnombre del profesorXX te tomará
                    ...
                    cuales estarás siempre orgulloso. Visítalo y mira a ver que te parece XXXlink de la paginaXXX.

                </li>
                    <li>Página web <a href='https://j2logo.com' target="_blank" rel="nofollow noopener noreferrer">www.j2logo.com</a>. El profesor Juan José Lozano Gómez
                    te dará un vistazo de la programación más contextualizada a la realidad. Te mostrará diferentes
                    ...
                    quieres irte familiarizando: XXXlink.
                    ...
                    tus habilidades <a href='https://codewars.com' target="_blank" rel="nofollow noopener noreferrer">www.codewars.com</a>. ¡Honor pequeño sensei, a practicar katas!
                </li>
            ...
            <ul>
                ...
                En <a href='https://stackoverflow.com' target="_blank" rel="nofollow noopener noreferrer">www.stackoverflow.com</a> respondieron a mis dudas particulares y así
                fuí learning - by - doing. Diviértete con el código acá:
                XXdireccion de githubXX.
            </li>
                ...
                Un código para optimizar la búsqueda podrás encontrarlo acá: XXdireccion de githubXX.
            </li>
                ...
                Volví a mi casa y al otro día fui a verlo. Mira lo que le mostré acá: XXdireccion de githubXX.
            </li>
            </ul>
        ...
        reirás de todo esto.</p>
            ...
            pertinente:
                <ul>
                    ...
                    <li><a href='./books/python/inventa-tus-propios-juegos-con-Python.pdf' type='application/pdf' download >Inventa-tus-propios-juegos-con-Python</a></li>
                    <li><a href='./books/python/python-by-vilar.pdf' type='application/pdf' download>Python-by-vilar.pdf</a></li>
                    <li><a href='./books/python/2019_Book_ABeginnersGuideToPython3Progra.pdf' type='application/pdf' download>2019_Book_ABeginnersGuideToPython3Progra.pdf</a></li>
                    <li><a href='./books/python/2019_Book_AdvancedGuideToPython3Programm.pdf' type='application/pdf' download>2019_Book_AdvancedGuideToPython3Programm.pdf</a></li>
                    <li><a href='./books/python/automate the boring stuff with python .pdf' type='application/pdf' download>Automate the boring stuff with python .pdf</a></li>


                </ul>
                Manos a la obra, rodéate de Python, usa internet, conversa, escucha, practica y por sobre todo <strong> diviértete</strong>.
                </p>
